...
# Logo UNP en esquina superior derecha
with open("unp.png", "rb") as image_file:
    encoded_logo = base64.b64encode(image_file.read()).decode()

st.markdown(f"""
<div style="position: fixed; top: 60px; right: 35px; z-index: 999;">
    <img src="data:image/png;base64,{encoded_logo}" width="85">
</div>
...
if data.empty:
    st.error("No se pudieron descargar datos válidos. Prueba con otros tickers o vuelve a intentar.")
    st.stop()
